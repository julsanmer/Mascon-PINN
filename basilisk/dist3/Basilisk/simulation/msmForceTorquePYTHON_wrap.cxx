...
#define SWIGTYPE_p_std__vectorT_Eigen__Vector3d_std__allocatorT_Eigen__Vector3d_t_t swig_types[19]
#define SWIGTYPE_p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t swig_types[20]
#define SWIGTYPE_p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t swig_types[21]
#define SWIGTYPE_p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t swig_types[22]
...
#define SWIGTYPE_p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t swig_types[24]
...
/*-----------------------------------------------
              @(target):= _msmForceTorque.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__msmForceTorque

#else
#  define SWIG_init    init_msmForceTorque

#endif
#define SWIG_name    "_msmForceTorque"
...
SWIGINTERN PyObject *_wrap_new_MsmForceTorque(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_MsmForceTorque", 0, 0, 0)) SWIG_fail;
  result = (MsmForceTorque *)new MsmForceTorque();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_MsmForceTorque, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_MsmForceTorque(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_MsmForceTorque" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_Reset(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  uint64_t arg2 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_Reset", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_Reset" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_long_SS_long(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MsmForceTorque_Reset" "', argument " "2"" of type '" "uint64_t""'");
  } 
  arg2 = static_cast< uint64_t >(val2);
  (arg1)->Reset(arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_UpdateState(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  uint64_t arg2 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_UpdateState", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_UpdateState" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_long_SS_long(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MsmForceTorque_UpdateState" "', argument " "2"" of type '" "uint64_t""'");
  } 
  arg2 = static_cast< uint64_t >(val2);
  (arg1)->UpdateState(arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_addSpacecraftToModel(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  Message< SCStatesMsgPayload > *arg2 = (Message< SCStatesMsgPayload > *) 0 ;
  SwigValueWrapper< std::vector< double,std::allocator< double > > > arg3 ;
  SwigValueWrapper< std::vector< Eigen::Vector3d,std::allocator< Eigen::Vector3d > > > arg4 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_addSpacecraftToModel", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_addSpacecraftToModel" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_MessageT_SCStatesMsgPayload_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_addSpacecraftToModel" "', argument " "2"" of type '" "Message< SCStatesMsgPayload > *""'"); 
  }
  arg2 = reinterpret_cast< Message< SCStatesMsgPayload > * >(argp2);
  {
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MsmForceTorque_addSpacecraftToModel" "', argument " "3"" of type '" "std::vector< double,std::allocator< double > >""'"); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MsmForceTorque_addSpacecraftToModel" "', argument " "3"" of type '" "std::vector< double,std::allocator< double > >""'");
    } else {
  ...
  {
    res4 = SWIG_ConvertPtr(swig_obj[3], &argp4, SWIGTYPE_p_std__vectorT_Eigen__Vector3d_std__allocatorT_Eigen__Vector3d_t_t,  0  | 0);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "MsmForceTorque_addSpacecraftToModel" "', argument " "4"" of type '" "std::vector< Eigen::Vector3d,std::allocator< Eigen::Vector3d > >""'"); 
    }  
    if (!argp4) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MsmForceTorque_addSpacecraftToModel" "', argument " "4"" of type '" "std::vector< Eigen::Vector3d,std::allocator< Eigen::Vector3d > >""'");
    } else {
      std::vector< Eigen::Vector3d,std::allocator< Eigen::Vector3d > > * temp = reinterpret_cast< std::vector< Eigen::Vector3d,std::allocator< Eigen::Vector3d > > * >(argp4);
      arg4 = *temp;
      if (SWIG_IsNewObj(res4)) delete temp;
    }
  }
  (arg1)->addSpacecraftToModel(arg2,arg3,arg4);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_scStateInMsgs_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_scStateInMsgs_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_scStateInMsgs_set" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_scStateInMsgs_set" "', argument " "2"" of type '" "std::vector< ReadFunctor< SCStatesMsgPayload >,std::allocator< ReadFunctor< SCStatesMsgPayload > > > *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_scStateInMsgs_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_scStateInMsgs_get" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_voltInMsgs_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > *arg2 = (std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_voltInMsgs_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_voltInMsgs_set" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_voltInMsgs_set" "', argument " "2"" of type '" "std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > *""'"); 
  }
  arg2 = reinterpret_cast< std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > * >(argp2);
  if (arg1) (arg1)->voltInMsgs = *arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_voltInMsgs_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > *result = 0 ;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_voltInMsgs_get" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  result = (std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > *)& ((arg1)->voltInMsgs);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_eTorqueOutMsgs_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > *arg2 = (std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_eTorqueOutMsgs_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_eTorqueOutMsgs_set" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_eTorqueOutMsgs_set" "', argument " "2"" of type '" "std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > *""'"); 
  }
  arg2 = reinterpret_cast< std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > * >(argp2);
  if (arg1) (arg1)->eTorqueOutMsgs = *arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_eTorqueOutMsgs_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > *result = 0 ;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_eTorqueOutMsgs_get" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  result = (std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > *)& ((arg1)->eTorqueOutMsgs);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_eForceOutMsgs_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > *arg2 = (std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_eForceOutMsgs_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_eForceOutMsgs_set" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_eForceOutMsgs_set" "', argument " "2"" of type '" "std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > *""'"); 
  }
  arg2 = reinterpret_cast< std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > * >(argp2);
  if (arg1) (arg1)->eForceOutMsgs = *arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_eForceOutMsgs_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > *result = 0 ;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_eForceOutMsgs_get" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  result = (std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > *)& ((arg1)->eForceOutMsgs);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_chargeMsmOutMsgs_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > *arg2 = (std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_chargeMsmOutMsgs_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_chargeMsmOutMsgs_set" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_chargeMsmOutMsgs_set" "', argument " "2"" of type '" "std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > *""'"); 
  }
  arg2 = reinterpret_cast< std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > * >(argp2);
  if (arg1) (arg1)->chargeMsmOutMsgs = *arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_chargeMsmOutMsgs_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > *result = 0 ;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_chargeMsmOutMsgs_get" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  result = (std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > *)& ((arg1)->chargeMsmOutMsgs);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_bskLogger_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "MsmForceTorque_bskLogger_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_bskLogger_set" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_BSKLogger, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MsmForceTorque_bskLogger_set" "', argument " "2"" of type '" "BSKLogger *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_MsmForceTorque_bskLogger_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MsmForceTorque *arg1 = (MsmForceTorque *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MsmForceTorque, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MsmForceTorque_bskLogger_get" "', argument " "1"" of type '" "MsmForceTorque *""'"); 
  }
  arg1 = reinterpret_cast< MsmForceTorque * >(argp1);
...
SWIGINTERN PyObject *MsmForceTorque_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_MsmForceTorque, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *MsmForceTorque_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
SWIGINTERN PyObject *_wrap_VoltMsgPayload_voltage_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  VoltMsgPayload *arg1 = (VoltMsgPayload *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double val2 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "VoltMsgPayload_voltage_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_VoltMsgPayload, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "VoltMsgPayload_voltage_set" "', argument " "1"" of type '" "VoltMsgPayload *""'"); 
  }
  arg1 = reinterpret_cast< VoltMsgPayload * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "VoltMsgPayload_voltage_set" "', argument " "2"" of type '" "double""'");
  } 
...
SWIGINTERN PyObject *_wrap_VoltMsgPayload_voltage_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  VoltMsgPayload *arg1 = (VoltMsgPayload *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_VoltMsgPayload, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "VoltMsgPayload_voltage_get" "', argument " "1"" of type '" "VoltMsgPayload *""'"); 
  }
  arg1 = reinterpret_cast< VoltMsgPayload * >(argp1);
...
SWIGINTERN PyObject *_wrap_new_VoltMsgPayload(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  VoltMsgPayload *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_VoltMsgPayload", 0, 0, 0)) SWIG_fail;
  result = (VoltMsgPayload *)new VoltMsgPayload();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_VoltMsgPayload, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_VoltMsgPayload(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  VoltMsgPayload *arg1 = (VoltMsgPayload *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_VoltMsgPayload, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_VoltMsgPayload" "', argument " "1"" of type '" "VoltMsgPayload *""'"); 
  }
  arg1 = reinterpret_cast< VoltMsgPayload * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *VoltMsgPayload_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_VoltMsgPayload, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *VoltMsgPayload_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
SWIGINTERN PyObject *_wrap_ChargeMsmMsgPayload_q_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ChargeMsmMsgPayload *arg1 = (ChargeMsmMsgPayload *) 0 ;
  Eigen::VectorXd arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[2] ;
  
  if (!SWIG_Python_UnpackTuple(args, "ChargeMsmMsgPayload_q_set", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_ChargeMsmMsgPayload, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChargeMsmMsgPayload_q_set" "', argument " "1"" of type '" "ChargeMsmMsgPayload *""'"); 
  }
  arg1 = reinterpret_cast< ChargeMsmMsgPayload * >(argp1);
  {
...
SWIGINTERN PyObject *_wrap_ChargeMsmMsgPayload_q_get(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ChargeMsmMsgPayload *arg1 = (ChargeMsmMsgPayload *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_ChargeMsmMsgPayload, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChargeMsmMsgPayload_q_get" "', argument " "1"" of type '" "ChargeMsmMsgPayload *""'"); 
  }
  arg1 = reinterpret_cast< ChargeMsmMsgPayload * >(argp1);
  {
    resultobj = PyList_New(0);
    fillPyObjList<Eigen::VectorXd>(resultobj,  ((arg1)->q));
    if (PyErr_Occurred()) SWIG_fail;
  }
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_new_ChargeMsmMsgPayload(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ChargeMsmMsgPayload *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_ChargeMsmMsgPayload", 0, 0, 0)) SWIG_fail;
  result = (ChargeMsmMsgPayload *)new ChargeMsmMsgPayload();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ChargeMsmMsgPayload, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_ChargeMsmMsgPayload(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ChargeMsmMsgPayload *arg1 = (ChargeMsmMsgPayload *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_ChargeMsmMsgPayload, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ChargeMsmMsgPayload" "', argument " "1"" of type '" "ChargeMsmMsgPayload *""'"); 
  }
  arg1 = reinterpret_cast< ChargeMsmMsgPayload * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *ChargeMsmMsgPayload_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_ChargeMsmMsgPayload, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *ChargeMsmMsgPayload_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_MsmForceTorque", _wrap_new_MsmForceTorque, METH_NOARGS, NULL},
	 { "delete_MsmForceTorque", _wrap_delete_MsmForceTorque, METH_O, NULL},
	 { "MsmForceTorque_Reset", _wrap_MsmForceTorque_Reset, METH_VARARGS, NULL},
	 { "MsmForceTorque_UpdateState", _wrap_MsmForceTorque_UpdateState, METH_VARARGS, NULL},
	 { "MsmForceTorque_addSpacecraftToModel", _wrap_MsmForceTorque_addSpacecraftToModel, METH_VARARGS, NULL},
	 { "MsmForceTorque_scStateInMsgs_set", _wrap_MsmForceTorque_scStateInMsgs_set, METH_VARARGS, NULL},
	 { "MsmForceTorque_scStateInMsgs_get", _wrap_MsmForceTorque_scStateInMsgs_get, METH_O, NULL},
	 { "MsmForceTorque_voltInMsgs_set", _wrap_MsmForceTorque_voltInMsgs_set, METH_VARARGS, NULL},
	 { "MsmForceTorque_voltInMsgs_get", _wrap_MsmForceTorque_voltInMsgs_get, METH_O, NULL},
	 { "MsmForceTorque_eTorqueOutMsgs_set", _wrap_MsmForceTorque_eTorqueOutMsgs_set, METH_VARARGS, NULL},
	 { "MsmForceTorque_eTorqueOutMsgs_get", _wrap_MsmForceTorque_eTorqueOutMsgs_get, METH_O, NULL},
	 { "MsmForceTorque_eForceOutMsgs_set", _wrap_MsmForceTorque_eForceOutMsgs_set, METH_VARARGS, NULL},
	 { "MsmForceTorque_eForceOutMsgs_get", _wrap_MsmForceTorque_eForceOutMsgs_get, METH_O, NULL},
	 { "MsmForceTorque_chargeMsmOutMsgs_set", _wrap_MsmForceTorque_chargeMsmOutMsgs_set, METH_VARARGS, NULL},
	 { "MsmForceTorque_chargeMsmOutMsgs_get", _wrap_MsmForceTorque_chargeMsmOutMsgs_get, METH_O, NULL},
	 { "MsmForceTorque_bskLogger_set", _wrap_MsmForceTorque_bskLogger_set, METH_VARARGS, NULL},
	 { "MsmForceTorque_bskLogger_get", _wrap_MsmForceTorque_bskLogger_get, METH_O, NULL},
	 { "MsmForceTorque_swigregister", MsmForceTorque_swigregister, METH_O, NULL},
	 { "MsmForceTorque_swiginit", MsmForceTorque_swiginit, METH_VARARGS, NULL},
	 ...
	 { "VoltMsgPayload_voltage_set", _wrap_VoltMsgPayload_voltage_set, METH_VARARGS, NULL},
	 { "VoltMsgPayload_voltage_get", _wrap_VoltMsgPayload_voltage_get, METH_O, NULL},
	 { "new_VoltMsgPayload", _wrap_new_VoltMsgPayload, METH_NOARGS, NULL},
	 { "delete_VoltMsgPayload", _wrap_delete_VoltMsgPayload, METH_O, NULL},
	 { "VoltMsgPayload_swigregister", VoltMsgPayload_swigregister, METH_O, NULL},
	 { "VoltMsgPayload_swiginit", VoltMsgPayload_swiginit, METH_VARARGS, NULL},
	 ...
	 { "ChargeMsmMsgPayload_q_set", _wrap_ChargeMsmMsgPayload_q_set, METH_VARARGS, NULL},
	 { "ChargeMsmMsgPayload_q_get", _wrap_ChargeMsmMsgPayload_q_get, METH_O, NULL},
	 { "new_ChargeMsmMsgPayload", _wrap_new_ChargeMsmMsgPayload, METH_NOARGS, NULL},
	 { "delete_ChargeMsmMsgPayload", _wrap_delete_ChargeMsmMsgPayload, METH_O, NULL},
	 { "ChargeMsmMsgPayload_swigregister", ChargeMsmMsgPayload_swigregister, METH_O, NULL},
	 { "ChargeMsmMsgPayload_swiginit", ChargeMsmMsgPayload_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static void *_p_MsmForceTorqueTo_p_SysModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SysModel *)  ((MsmForceTorque *) x));
}
static swig_type_info _swigt__p_BSKLogger = {"_p_BSKLogger", "BSKLogger *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ChargeMsmMsgPayload = {"_p_ChargeMsmMsgPayload", "ChargeMsmMsgPayload *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_MsmForceTorque = {"_p_MsmForceTorque", "MsmForceTorque *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_VoltMsgPayload = {"_p_VoltMsgPayload", "VoltMsgPayload *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t = {"_p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t", "std::vector< Message< ChargeMsmMsgPayload > *,std::allocator< Message< ChargeMsmMsgPayload > * > > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t = {"_p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t", "std::vector< Message< CmdForceInertialMsgPayload > *,std::allocator< Message< CmdForceInertialMsgPayload > * > > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t = {"_p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t", "std::vector< Message< CmdTorqueBodyMsgPayload > *,std::allocator< Message< CmdTorqueBodyMsgPayload > * > > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t = {"_p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t", "std::vector< ReadFunctor< VoltMsgPayload >,std::allocator< ReadFunctor< VoltMsgPayload > > > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t,
  &_swigt__p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t,
  &_swigt__p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t,
  &_swigt__p_std__vectorT_ReadFunctorT_SCStatesMsgPayload_t_std__allocatorT_ReadFunctorT_SCStatesMsgPayload_t_t_t,
  &_swigt__p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t,
...
static swig_cast_info _swigc__p_ChargeMsmMsgPayload[] = {  {&_swigt__p_ChargeMsmMsgPayload, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_MsmForceTorque[] = {  {&_swigt__p_MsmForceTorque, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SCStatesMsgPayload[] = {  {&_swigt__p_SCStatesMsgPayload, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SysModel[] = {  {&_swigt__p_SysModel, 0, 0, 0},  {&_swigt__p_MsmForceTorque, _p_MsmForceTorqueTo_p_SysModel, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_VoltMsgPayload[] = {  {&_swigt__p_VoltMsgPayload, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t[] = {  {&_swigt__p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t[] = {  {&_swigt__p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t[] = {  {&_swigt__p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t[] = {  {&_swigt__p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_std__vectorT_MessageT_ChargeMsmMsgPayload_t_p_std__allocatorT_MessageT_ChargeMsmMsgPayload_t_p_t_t,
  _swigc__p_std__vectorT_MessageT_CmdForceInertialMsgPayload_t_p_std__allocatorT_MessageT_CmdForceInertialMsgPayload_t_p_t_t,
  _swigc__p_std__vectorT_MessageT_CmdTorqueBodyMsgPayload_t_p_std__allocatorT_MessageT_CmdTorqueBodyMsgPayload_t_p_t_t,
  _swigc__p_std__vectorT_ReadFunctorT_SCStatesMsgPayload_t_std__allocatorT_ReadFunctorT_SCStatesMsgPayload_t_t_t,
  _swigc__p_std__vectorT_ReadFunctorT_VoltMsgPayload_t_std__allocatorT_ReadFunctorT_VoltMsgPayload_t_t_t,
