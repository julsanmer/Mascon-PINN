...
#define SWIGTYPE_p_SimplePowerMonitor swig_types[6]
...
/*-----------------------------------------------
              @(target):= _simplePowerMonitor.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__simplePowerMonitor

#else
#  define SWIG_init    init_simplePowerMonitor

#endif
#define SWIG_name    "_simplePowerMonitor"
...
SWIGINTERN PyObject *_wrap_new_SimplePowerMonitor(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  SimplePowerMonitor *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_SimplePowerMonitor", 0, 0, 0)) SWIG_fail;
  result = (SimplePowerMonitor *)new SimplePowerMonitor();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_SimplePowerMonitor, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_SimplePowerMonitor(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  SimplePowerMonitor *arg1 = (SimplePowerMonitor *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_SimplePowerMonitor, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_SimplePowerMonitor" "', argument " "1"" of type '" "SimplePowerMonitor *""'"); 
  }
  arg1 = reinterpret_cast< SimplePowerMonitor * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *SimplePowerMonitor_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_SimplePowerMonitor, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *SimplePowerMonitor_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_SimplePowerMonitor", _wrap_new_SimplePowerMonitor, METH_NOARGS, NULL},
	 { "delete_SimplePowerMonitor", _wrap_delete_SimplePowerMonitor, METH_O, NULL},
	 { "SimplePowerMonitor_swigregister", SimplePowerMonitor_swigregister, METH_O, NULL},
	 { "SimplePowerMonitor_swiginit", SimplePowerMonitor_swiginit, METH_VARARGS, NULL},
...
static void *_p_SimplePowerMonitorTo_p_PowerStorageBase(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((PowerStorageBase *)  ((SimplePowerMonitor *) x));
}
static void *_p_PowerStorageBaseTo_p_SysModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SysModel *)  ((PowerStorageBase *) x));
}
static void *_p_SimplePowerMonitorTo_p_SysModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SysModel *) (PowerStorageBase *) ((SimplePowerMonitor *) x));
}
...
static swig_type_info _swigt__p_SimplePowerMonitor = {"_p_SimplePowerMonitor", "SimplePowerMonitor *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_PowerStorageBase[] = {  {&_swigt__p_PowerStorageBase, 0, 0, 0},  {&_swigt__p_SimplePowerMonitor, _p_SimplePowerMonitorTo_p_PowerStorageBase, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_PowerStorageStatusMsgPayload[] = {  {&_swigt__p_PowerStorageStatusMsgPayload, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SimplePowerMonitor[] = {  {&_swigt__p_SimplePowerMonitor, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SysModel[] = {  {&_swigt__p_SysModel, 0, 0, 0},  {&_swigt__p_PowerStorageBase, _p_PowerStorageBaseTo_p_SysModel, 0, 0},  {&_swigt__p_SimplePowerMonitor, _p_SimplePowerMonitorTo_p_SysModel, 0, 0},{0, 0, 0, 0}};
