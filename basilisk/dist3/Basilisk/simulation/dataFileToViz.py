...
class InstrumentGuiSettings(object):
    ...
    showMultiSphereLabels = property(_dataFileToViz.InstrumentGuiSettings_showMultiSphereLabels_get, _dataFileToViz.InstrumentGuiSettings_showMultiSphereLabels_set)
...
class MultiSphere(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    isOn = property(_dataFileToViz.MultiSphere_isOn_get, _dataFileToViz.MultiSphere_isOn_set)
    position = property(_dataFileToViz.MultiSphere_position_get, _dataFileToViz.MultiSphere_position_set)
    radius = property(_dataFileToViz.MultiSphere_radius_get, _dataFileToViz.MultiSphere_radius_set)
    currentValue = property(_dataFileToViz.MultiSphere_currentValue_get, _dataFileToViz.MultiSphere_currentValue_set)
    maxValue = property(_dataFileToViz.MultiSphere_maxValue_get, _dataFileToViz.MultiSphere_maxValue_set)
    positiveColor = property(_dataFileToViz.MultiSphere_positiveColor_get, _dataFileToViz.MultiSphere_positiveColor_set)
    negativeColor = property(_dataFileToViz.MultiSphere_negativeColor_get, _dataFileToViz.MultiSphere_negativeColor_set)
    neutralOpacity = property(_dataFileToViz.MultiSphere_neutralOpacity_get, _dataFileToViz.MultiSphere_neutralOpacity_set)

    def __init__(self):
        _dataFileToViz.MultiSphere_swiginit(self, _dataFileToViz.new_MultiSphere())
    __swig_destroy__ = _dataFileToViz.delete_MultiSphere

# Register MultiSphere in _dataFileToViz:
_dataFileToViz.MultiSphere_swigregister(MultiSphere)
class MultiSphereInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    msmList = property(_dataFileToViz.MultiSphereInfo_msmList_get, _dataFileToViz.MultiSphereInfo_msmList_set)
    msmChargeInMsg = property(_dataFileToViz.MultiSphereInfo_msmChargeInMsg_get, _dataFileToViz.MultiSphereInfo_msmChargeInMsg_set)

    def __init__(self):
        _dataFileToViz.MultiSphereInfo_swiginit(self, _dataFileToViz.new_MultiSphereInfo())
    __swig_destroy__ = _dataFileToViz.delete_MultiSphereInfo

# Register MultiSphereInfo in _dataFileToViz:
_dataFileToViz.MultiSphereInfo_swigregister(MultiSphereInfo)
...
class VizSettings(object):
    ...
    customGUIScale = property(_dataFileToViz.VizSettings_customGUIScale_get, _dataFileToViz.VizSettings_customGUIScale_set)
