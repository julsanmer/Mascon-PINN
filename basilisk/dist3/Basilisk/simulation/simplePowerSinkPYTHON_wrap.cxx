...
#define SWIGTYPE_p_ReadFunctorT_DeviceStatusMsgPayload_t swig_types[5]
#define SWIGTYPE_p_SimplePowerSink swig_types[6]
...
/*-----------------------------------------------
              @(target):= _simplePowerSink.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__simplePowerSink

#else
#  define SWIG_init    init_simplePowerSink

#endif
#define SWIG_name    "_simplePowerSink"
...
SWIGINTERN PyObject *_wrap_new_SimplePowerSink(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  SimplePowerSink *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_SimplePowerSink", 0, 0, 0)) SWIG_fail;
  result = (SimplePowerSink *)new SimplePowerSink();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_SimplePowerSink, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_SimplePowerSink(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  SimplePowerSink *arg1 = (SimplePowerSink *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_SimplePowerSink, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_SimplePowerSink" "', argument " "1"" of type '" "SimplePowerSink *""'"); 
  }
  arg1 = reinterpret_cast< SimplePowerSink * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *SimplePowerSink_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_SimplePowerSink, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *SimplePowerSink_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_SimplePowerSink", _wrap_new_SimplePowerSink, METH_NOARGS, NULL},
	 { "delete_SimplePowerSink", _wrap_delete_SimplePowerSink, METH_O, NULL},
	 { "SimplePowerSink_swigregister", SimplePowerSink_swigregister, METH_O, NULL},
	 { "SimplePowerSink_swiginit", SimplePowerSink_swiginit, METH_VARARGS, NULL},
...
static void *_p_SimplePowerSinkTo_p_PowerNodeBase(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((PowerNodeBase *)  ((SimplePowerSink *) x));
}
static void *_p_PowerNodeBaseTo_p_SysModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SysModel *)  ((PowerNodeBase *) x));
}
static void *_p_SimplePowerSinkTo_p_SysModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SysModel *) (PowerNodeBase *) ((SimplePowerSink *) x));
}
...
static swig_type_info _swigt__p_SimplePowerSink = {"_p_SimplePowerSink", "SimplePowerSink *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_PowerNodeBase[] = {  {&_swigt__p_PowerNodeBase, 0, 0, 0},  {&_swigt__p_SimplePowerSink, _p_SimplePowerSinkTo_p_PowerNodeBase, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_SimplePowerSink[] = {  {&_swigt__p_SimplePowerSink, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SysModel[] = {  {&_swigt__p_SysModel, 0, 0, 0},  {&_swigt__p_PowerNodeBase, _p_PowerNodeBaseTo_p_SysModel, 0, 0},  {&_swigt__p_SimplePowerSink, _p_SimplePowerSinkTo_p_SysModel, 0, 0},{0, 0, 0, 0}};
