...
#define SWIGTYPE_p_logLevel_t swig_types[2]
#define SWIGTYPE_p_std__mapT_int_char_const_p_t swig_types[3]
...
/*-----------------------------------------------
              @(target):= _bskLogging.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__bskLogging

#else
#  define SWIG_init    init_bskLogging

#endif
#define SWIG_name    "_bskLogging"
