...
#define SWIGTYPE_p_ModuleIdGenerator swig_types[0]
...
/*-----------------------------------------------
              @(target):= _moduleIdGenerator.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__moduleIdGenerator

#else
#  define SWIG_init    init_moduleIdGenerator

#endif
#define SWIG_name    "_moduleIdGenerator"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_ModuleIdGenerator_checkoutModuleID(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ModuleIdGenerator *arg1 = (ModuleIdGenerator *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  int64_t result;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_ModuleIdGenerator, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ModuleIdGenerator_checkoutModuleID" "', argument " "1"" of type '" "ModuleIdGenerator *""'"); 
  }
  arg1 = reinterpret_cast< ModuleIdGenerator * >(argp1);
  result = (int64_t)(arg1)->checkoutModuleID();
...
SWIGINTERN PyObject *_wrap_ModuleIdGenerator_GetInstance(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ModuleIdGenerator *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "ModuleIdGenerator_GetInstance", 0, 0, 0)) SWIG_fail;
  result = (ModuleIdGenerator *)ModuleIdGenerator::GetInstance();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ModuleIdGenerator, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *ModuleIdGenerator_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_ModuleIdGenerator, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

static PyMethodDef SwigMethods[] = {
	 { "ModuleIdGenerator_checkoutModuleID", _wrap_ModuleIdGenerator_checkoutModuleID, METH_O, NULL},
	 { "ModuleIdGenerator_GetInstance", _wrap_ModuleIdGenerator_GetInstance, METH_NOARGS, NULL},
	 { "ModuleIdGenerator_swigregister", ModuleIdGenerator_swigregister, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_ModuleIdGenerator = {"_p_ModuleIdGenerator", "ModuleIdGenerator *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_ModuleIdGenerator[] = {  {&_swigt__p_ModuleIdGenerator, 0, 0, 0},{0, 0, 0, 0}};
