...
%module PowerNodeUsageMsgPayload
%{
...
%template(PowerNodeUsageMsgOutMsgsVector) std::vector<Message<PowerNodeUsageMsgPayload>>;
%template(PowerNodeUsageMsgOutMsgsPtrVector) std::vector<Message<PowerNodeUsageMsgPayload>*>;
%template(PowerNodeUsageMsgInMsgsVector) std::vector<ReadFunctor<PowerNodeUsageMsgPayload>>;
