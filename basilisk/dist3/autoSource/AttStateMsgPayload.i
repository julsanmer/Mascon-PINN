...
%template(AttStateMsgOutMsgsVector) std::vector<Message<AttStateMsgPayload>>;
%template(AttStateMsgOutMsgsPtrVector) std::vector<Message<AttStateMsgPayload>*>;
%template(AttStateMsgInMsgsVector) std::vector<ReadFunctor<AttStateMsgPayload>>;
