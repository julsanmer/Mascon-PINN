...
%module MTBMsgPayload
%{
    #include "msgPayloadDefC/MTBMsgPayload.h"
...
%template(MTBMsgOutMsgsVector) std::vector<Message<MTBMsgPayload>>;
%template(MTBMsgOutMsgsPtrVector) std::vector<Message<MTBMsgPayload>*>;
%template(MTBMsgInMsgsVector) std::vector<ReadFunctor<MTBMsgPayload>>;
