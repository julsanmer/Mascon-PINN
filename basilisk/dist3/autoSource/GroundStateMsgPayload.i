...
%template(GroundStateMsgOutMsgsVector) std::vector<Message<GroundStateMsgPayload>>;
%template(GroundStateMsgOutMsgsPtrVector) std::vector<Message<GroundStateMsgPayload>*>;
%template(GroundStateMsgInMsgsVector) std::vector<ReadFunctor<GroundStateMsgPayload>>;
