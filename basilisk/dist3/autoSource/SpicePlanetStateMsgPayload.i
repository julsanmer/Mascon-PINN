...
%module SpicePlanetStateMsgPayload
%{
...
%template(SpicePlanetStateMsgOutMsgsVector) std::vector<Message<SpicePlanetStateMsgPayload>>;
%template(SpicePlanetStateMsgOutMsgsPtrVector) std::vector<Message<SpicePlanetStateMsgPayload>*>;
%template(SpicePlanetStateMsgInMsgsVector) std::vector<ReadFunctor<SpicePlanetStateMsgPayload>>;
