...
%module OpNavCirclesMsgPayload
%{
    #include "msgPayloadDefC/OpNavCirclesMsgPayload.h"
...
%template(OpNavCirclesMsgOutMsgsVector) std::vector<Message<OpNavCirclesMsgPayload>>;
%template(OpNavCirclesMsgOutMsgsPtrVector) std::vector<Message<OpNavCirclesMsgPayload>*>;
%template(OpNavCirclesMsgInMsgsVector) std::vector<ReadFunctor<OpNavCirclesMsgPayload>>;
