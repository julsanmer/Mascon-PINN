...
%module THRArrayOnTimeCmdMsgPayload
%{
...
%template(THRArrayOnTimeCmdMsgOutMsgsVector) std::vector<Message<THRArrayOnTimeCmdMsgPayload>>;
%template(THRArrayOnTimeCmdMsgOutMsgsPtrVector) std::vector<Message<THRArrayOnTimeCmdMsgPayload>*>;
%template(THRArrayOnTimeCmdMsgInMsgsVector) std::vector<ReadFunctor<THRArrayOnTimeCmdMsgPayload>>;
