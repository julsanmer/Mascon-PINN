...
%module VoltMsgPayload
%{
    #include "msgPayloadDefC/VoltMsgPayload.h"
...
%template(VoltMsgOutMsgsVector) std::vector<Message<VoltMsgPayload>>;
%template(VoltMsgOutMsgsPtrVector) std::vector<Message<VoltMsgPayload>*>;
%template(VoltMsgInMsgsVector) std::vector<ReadFunctor<VoltMsgPayload>>;
