...
%module InertialFilterMsgPayload
%{
...
%template(InertialFilterMsgOutMsgsVector) std::vector<Message<InertialFilterMsgPayload>>;
%template(InertialFilterMsgOutMsgsPtrVector) std::vector<Message<InertialFilterMsgPayload>*>;
%template(InertialFilterMsgInMsgsVector) std::vector<ReadFunctor<InertialFilterMsgPayload>>;
