...
%template(CSSRawDataMsgOutMsgsVector) std::vector<Message<CSSRawDataMsgPayload>>;
%template(CSSRawDataMsgOutMsgsPtrVector) std::vector<Message<CSSRawDataMsgPayload>*>;
%template(CSSRawDataMsgInMsgsVector) std::vector<ReadFunctor<CSSRawDataMsgPayload>>;
