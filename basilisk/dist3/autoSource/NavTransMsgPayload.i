...
%template(NavTransMsgOutMsgsVector) std::vector<Message<NavTransMsgPayload>>;
%template(NavTransMsgOutMsgsPtrVector) std::vector<Message<NavTransMsgPayload>*>;
%template(NavTransMsgInMsgsVector) std::vector<ReadFunctor<NavTransMsgPayload>>;
