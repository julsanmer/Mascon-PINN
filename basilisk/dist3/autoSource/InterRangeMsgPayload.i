...
%};
%include "msgPayloadDefC/InterRangeMsgPayload.h"
INSTANTIATE_TEMPLATES(InterRangeMsg, InterRangeMsgPayload, msgPayloadDefC)
%template(InterRangeMsgOutMsgsVector) std::vector<Message<InterRangeMsgPayload>>;
%template(InterRangeMsgOutMsgsPtrVector) std::vector<Message<InterRangeMsgPayload>*>;
%template(InterRangeMsgInMsgsVector) std::vector<ReadFunctor<InterRangeMsgPayload>>;
