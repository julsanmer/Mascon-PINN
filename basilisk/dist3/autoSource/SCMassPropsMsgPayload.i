...
%template(SCMassPropsMsgOutMsgsVector) std::vector<Message<SCMassPropsMsgPayload>>;
%template(SCMassPropsMsgOutMsgsPtrVector) std::vector<Message<SCMassPropsMsgPayload>*>;
%template(SCMassPropsMsgInMsgsVector) std::vector<ReadFunctor<SCMassPropsMsgPayload>>;
