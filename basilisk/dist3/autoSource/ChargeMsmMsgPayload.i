...
%module ChargeMsmMsgPayload
%{
    #include "msgPayloadDefCpp/ChargeMsmMsgPayload.h"
...
%template(ChargeMsmMsgOutMsgsVector) std::vector<Message<ChargeMsmMsgPayload>>;
%template(ChargeMsmMsgOutMsgsPtrVector) std::vector<Message<ChargeMsmMsgPayload>*>;
%template(ChargeMsmMsgInMsgsVector) std::vector<ReadFunctor<ChargeMsmMsgPayload>>;
