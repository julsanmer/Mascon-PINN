...
%template(VSCMGCmdMsgOutMsgsVector) std::vector<Message<VSCMGCmdMsgPayload>>;
%template(VSCMGCmdMsgOutMsgsPtrVector) std::vector<Message<VSCMGCmdMsgPayload>*>;
%template(VSCMGCmdMsgInMsgsVector) std::vector<ReadFunctor<VSCMGCmdMsgPayload>>;
