...
%module TransRefMsgPayload
%{
    #include "msgPayloadDefC/TransRefMsgPayload.h"
...
%template(TransRefMsgOutMsgsVector) std::vector<Message<TransRefMsgPayload>>;
%template(TransRefMsgOutMsgsPtrVector) std::vector<Message<TransRefMsgPayload>*>;
%template(TransRefMsgInMsgsVector) std::vector<ReadFunctor<TransRefMsgPayload>>;
