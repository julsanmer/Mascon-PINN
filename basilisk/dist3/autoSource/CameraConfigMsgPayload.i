...
%template(CameraConfigMsgOutMsgsVector) std::vector<Message<CameraConfigMsgPayload>>;
%template(CameraConfigMsgOutMsgsPtrVector) std::vector<Message<CameraConfigMsgPayload>*>;
%template(CameraConfigMsgInMsgsVector) std::vector<ReadFunctor<CameraConfigMsgPayload>>;
