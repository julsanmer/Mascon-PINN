...
%template(RWCmdMsgOutMsgsVector) std::vector<Message<RWCmdMsgPayload>>;
%template(RWCmdMsgOutMsgsPtrVector) std::vector<Message<RWCmdMsgPayload>*>;
%template(RWCmdMsgInMsgsVector) std::vector<ReadFunctor<RWCmdMsgPayload>>;
