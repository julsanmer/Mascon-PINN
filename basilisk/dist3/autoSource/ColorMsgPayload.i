...
%module ColorMsgPayload
%{
    #include "msgPayloadDefC/ColorMsgPayload.h"
...
%template(ColorMsgOutMsgsVector) std::vector<Message<ColorMsgPayload>>;
%template(ColorMsgOutMsgsPtrVector) std::vector<Message<ColorMsgPayload>*>;
%template(ColorMsgInMsgsVector) std::vector<ReadFunctor<ColorMsgPayload>>;
