...
%template(SCStatesMsgOutMsgsVector) std::vector<Message<SCStatesMsgPayload>>;
%template(SCStatesMsgOutMsgsPtrVector) std::vector<Message<SCStatesMsgPayload>*>;
%template(SCStatesMsgInMsgsVector) std::vector<ReadFunctor<SCStatesMsgPayload>>;
