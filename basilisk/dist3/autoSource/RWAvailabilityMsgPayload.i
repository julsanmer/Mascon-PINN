...
%module RWAvailabilityMsgPayload
%{
...
%template(RWAvailabilityMsgOutMsgsVector) std::vector<Message<RWAvailabilityMsgPayload>>;
%template(RWAvailabilityMsgOutMsgsPtrVector) std::vector<Message<RWAvailabilityMsgPayload>*>;
%template(RWAvailabilityMsgInMsgsVector) std::vector<ReadFunctor<RWAvailabilityMsgPayload>>;
