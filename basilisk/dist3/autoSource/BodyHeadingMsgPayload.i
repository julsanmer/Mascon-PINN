...
%template(BodyHeadingMsgOutMsgsVector) std::vector<Message<BodyHeadingMsgPayload>>;
%template(BodyHeadingMsgOutMsgsPtrVector) std::vector<Message<BodyHeadingMsgPayload>*>;
%template(BodyHeadingMsgInMsgsVector) std::vector<ReadFunctor<BodyHeadingMsgPayload>>;
