...
%module CModuleTemplateMsgPayload
%{
    #include "msgPayloadDefC/CModuleTemplateMsgPayload.h"
...
%template(CModuleTemplateMsgOutMsgsVector) std::vector<Message<CModuleTemplateMsgPayload>>;
%template(CModuleTemplateMsgOutMsgsPtrVector) std::vector<Message<CModuleTemplateMsgPayload>*>;
%template(CModuleTemplateMsgInMsgsVector) std::vector<ReadFunctor<CModuleTemplateMsgPayload>>;
