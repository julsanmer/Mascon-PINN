...
%module SolarFluxMsgPayload
%{
    #include "msgPayloadDefC/SolarFluxMsgPayload.h"
...
%template(SolarFluxMsgOutMsgsVector) std::vector<Message<SolarFluxMsgPayload>>;
%template(SolarFluxMsgOutMsgsPtrVector) std::vector<Message<SolarFluxMsgPayload>*>;
%template(SolarFluxMsgInMsgsVector) std::vector<ReadFunctor<SolarFluxMsgPayload>>;
