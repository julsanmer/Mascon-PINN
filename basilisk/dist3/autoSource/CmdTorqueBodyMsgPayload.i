...
%module CmdTorqueBodyMsgPayload
%{
...
%template(CmdTorqueBodyMsgOutMsgsVector) std::vector<Message<CmdTorqueBodyMsgPayload>>;
%template(CmdTorqueBodyMsgOutMsgsPtrVector) std::vector<Message<CmdTorqueBodyMsgPayload>*>;
%template(CmdTorqueBodyMsgInMsgsVector) std::vector<ReadFunctor<CmdTorqueBodyMsgPayload>>;
