...
%module LandmarkMsgPayload
%{
    #include "msgPayloadDefC/LandmarkMsgPayload.h"
...
%template(LandmarkMsgOutMsgsVector) std::vector<Message<LandmarkMsgPayload>>;
%template(LandmarkMsgOutMsgsPtrVector) std::vector<Message<LandmarkMsgPayload>*>;
%template(LandmarkMsgInMsgsVector) std::vector<ReadFunctor<LandmarkMsgPayload>>;
