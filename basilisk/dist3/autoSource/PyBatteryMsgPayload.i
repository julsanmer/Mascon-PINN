...
%module PyBatteryMsgPayload
%{
    #include "msgPayloadDefC/PyBatteryMsgPayload.h"
...
%template(PyBatteryMsgOutMsgsVector) std::vector<Message<PyBatteryMsgPayload>>;
%template(PyBatteryMsgOutMsgsPtrVector) std::vector<Message<PyBatteryMsgPayload>*>;
%template(PyBatteryMsgInMsgsVector) std::vector<ReadFunctor<PyBatteryMsgPayload>>;
