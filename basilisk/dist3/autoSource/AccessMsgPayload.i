...
%template(AccessMsgOutMsgsVector) std::vector<Message<AccessMsgPayload>>;
%template(AccessMsgOutMsgsPtrVector) std::vector<Message<AccessMsgPayload>*>;
%template(AccessMsgInMsgsVector) std::vector<ReadFunctor<AccessMsgPayload>>;
