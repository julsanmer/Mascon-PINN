...
%module HingedRigidBodyMsgPayload
%{
...
%template(HingedRigidBodyMsgOutMsgsVector) std::vector<Message<HingedRigidBodyMsgPayload>>;
%template(HingedRigidBodyMsgOutMsgsPtrVector) std::vector<Message<HingedRigidBodyMsgPayload>*>;
%template(HingedRigidBodyMsgInMsgsVector) std::vector<ReadFunctor<HingedRigidBodyMsgPayload>>;
