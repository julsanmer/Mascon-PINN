...
%module ReconfigBurnInfoMsgPayload
%{
    #include "msgPayloadDefC/ReconfigBurnInfoMsgPayload.h"
...
%template(ReconfigBurnInfoMsgOutMsgsVector) std::vector<Message<ReconfigBurnInfoMsgPayload>>;
%template(ReconfigBurnInfoMsgOutMsgsPtrVector) std::vector<Message<ReconfigBurnInfoMsgPayload>*>;
%template(ReconfigBurnInfoMsgInMsgsVector) std::vector<ReadFunctor<ReconfigBurnInfoMsgPayload>>;
