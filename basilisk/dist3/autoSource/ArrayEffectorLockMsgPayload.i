...
%module ArrayEffectorLockMsgPayload
%{
    #include "msgPayloadDefC/ArrayEffectorLockMsgPayload.h"
...
%template(ArrayEffectorLockMsgOutMsgsVector) std::vector<Message<ArrayEffectorLockMsgPayload>>;
%template(ArrayEffectorLockMsgOutMsgsPtrVector) std::vector<Message<ArrayEffectorLockMsgPayload>*>;
%template(ArrayEffectorLockMsgInMsgsVector) std::vector<ReadFunctor<ArrayEffectorLockMsgPayload>>;
