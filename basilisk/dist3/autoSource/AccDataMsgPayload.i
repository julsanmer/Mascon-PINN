...
%template(AccDataMsgOutMsgsVector) std::vector<Message<AccDataMsgPayload>>;
%template(AccDataMsgOutMsgsPtrVector) std::vector<Message<AccDataMsgPayload>*>;
%template(AccDataMsgInMsgsVector) std::vector<ReadFunctor<AccDataMsgPayload>>;
