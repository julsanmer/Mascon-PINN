...
%module SmallBodyNavUKF5MsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNavUKF5MsgPayload.h"
...
%};
%include "msgPayloadDefC/SmallBodyNavUKF5MsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNavUKF5Msg, SmallBodyNavUKF5MsgPayload, msgPayloadDefC)
%template(SmallBodyNavUKF5MsgOutMsgsVector) std::vector<Message<SmallBodyNavUKF5MsgPayload>>;
%template(SmallBodyNavUKF5MsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavUKF5MsgPayload>*>;
%template(SmallBodyNavUKF5MsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavUKF5MsgPayload>>;
