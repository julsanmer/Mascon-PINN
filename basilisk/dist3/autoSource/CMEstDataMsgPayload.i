...
%module CMEstDataMsgPayload
%{
    #include "msgPayloadDefC/CMEstDataMsgPayload.h"
...
%template(CMEstDataMsgOutMsgsVector) std::vector<Message<CMEstDataMsgPayload>>;
%template(CMEstDataMsgOutMsgsPtrVector) std::vector<Message<CMEstDataMsgPayload>*>;
%template(CMEstDataMsgInMsgsVector) std::vector<ReadFunctor<CMEstDataMsgPayload>>;
