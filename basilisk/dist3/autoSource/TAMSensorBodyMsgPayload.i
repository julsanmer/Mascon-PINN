...
%module TAMSensorBodyMsgPayload
%{
...
%template(TAMSensorBodyMsgOutMsgsVector) std::vector<Message<TAMSensorBodyMsgPayload>>;
%template(TAMSensorBodyMsgOutMsgsPtrVector) std::vector<Message<TAMSensorBodyMsgPayload>*>;
%template(TAMSensorBodyMsgInMsgsVector) std::vector<ReadFunctor<TAMSensorBodyMsgPayload>>;
