...
%module SmallbodyDMCUKFMsgPayload
%{
...
%};
%include "msgPayloadDefC/SmallbodyDMCUKFMsgPayload.h"
INSTANTIATE_TEMPLATES(SmallbodyDMCUKFMsg, SmallbodyDMCUKFMsgPayload, msgPayloadDefC)
%template(SmallbodyDMCUKFMsgOutMsgsVector) std::vector<Message<SmallbodyDMCUKFMsgPayload>>;
%template(SmallbodyDMCUKFMsgOutMsgsPtrVector) std::vector<Message<SmallbodyDMCUKFMsgPayload>*>;
%template(SmallbodyDMCUKFMsgInMsgsVector) std::vector<ReadFunctor<SmallbodyDMCUKFMsgPayload>>;
