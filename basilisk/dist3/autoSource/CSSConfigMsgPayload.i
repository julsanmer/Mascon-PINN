...
%template(CSSConfigMsgOutMsgsVector) std::vector<Message<CSSConfigMsgPayload>>;
%template(CSSConfigMsgOutMsgsPtrVector) std::vector<Message<CSSConfigMsgPayload>*>;
%template(CSSConfigMsgInMsgsVector) std::vector<ReadFunctor<CSSConfigMsgPayload>>;
