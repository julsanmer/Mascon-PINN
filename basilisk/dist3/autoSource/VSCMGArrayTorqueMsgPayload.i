...
%module VSCMGArrayTorqueMsgPayload
%{
...
%template(VSCMGArrayTorqueMsgOutMsgsVector) std::vector<Message<VSCMGArrayTorqueMsgPayload>>;
%template(VSCMGArrayTorqueMsgOutMsgsPtrVector) std::vector<Message<VSCMGArrayTorqueMsgPayload>*>;
%template(VSCMGArrayTorqueMsgInMsgsVector) std::vector<ReadFunctor<VSCMGArrayTorqueMsgPayload>>;
