...
%template(BoreAngleMsgOutMsgsVector) std::vector<Message<BoreAngleMsgPayload>>;
%template(BoreAngleMsgOutMsgsPtrVector) std::vector<Message<BoreAngleMsgPayload>*>;
%template(BoreAngleMsgInMsgsVector) std::vector<ReadFunctor<BoreAngleMsgPayload>>;
