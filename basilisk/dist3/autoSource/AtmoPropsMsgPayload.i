...
%template(AtmoPropsMsgOutMsgsVector) std::vector<Message<AtmoPropsMsgPayload>>;
%template(AtmoPropsMsgOutMsgsPtrVector) std::vector<Message<AtmoPropsMsgPayload>*>;
%template(AtmoPropsMsgInMsgsVector) std::vector<ReadFunctor<AtmoPropsMsgPayload>>;
