...
%template(STAttMsgOutMsgsVector) std::vector<Message<STAttMsgPayload>>;
%template(STAttMsgOutMsgsPtrVector) std::vector<Message<STAttMsgPayload>*>;
%template(STAttMsgInMsgsVector) std::vector<ReadFunctor<STAttMsgPayload>>;
