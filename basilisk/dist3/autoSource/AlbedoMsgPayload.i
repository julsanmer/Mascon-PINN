...
%template(AlbedoMsgOutMsgsVector) std::vector<Message<AlbedoMsgPayload>>;
%template(AlbedoMsgOutMsgsPtrVector) std::vector<Message<AlbedoMsgPayload>*>;
%template(AlbedoMsgInMsgsVector) std::vector<ReadFunctor<AlbedoMsgPayload>>;
