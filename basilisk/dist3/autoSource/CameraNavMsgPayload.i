...
%};
%include "msgPayloadDefC/CameraNavMsgPayload.h"
INSTANTIATE_TEMPLATES(CameraNavMsg, CameraNavMsgPayload, msgPayloadDefC)
%template(CameraNavMsgOutMsgsVector) std::vector<Message<CameraNavMsgPayload>>;
%template(CameraNavMsgOutMsgsPtrVector) std::vector<Message<CameraNavMsgPayload>*>;
%template(CameraNavMsgInMsgsVector) std::vector<ReadFunctor<CameraNavMsgPayload>>;
