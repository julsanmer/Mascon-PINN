...
%module RWArrayConfigMsgPayload
%{
...
%template(RWArrayConfigMsgOutMsgsVector) std::vector<Message<RWArrayConfigMsgPayload>>;
%template(RWArrayConfigMsgOutMsgsPtrVector) std::vector<Message<RWArrayConfigMsgPayload>*>;
%template(RWArrayConfigMsgInMsgsVector) std::vector<ReadFunctor<RWArrayConfigMsgPayload>>;
