...
#ifndef DMCUKFMsg_C_H
#define DMCUKFMsg_C_H

#include <stdint.h>
#include "architecture/../../External/msgPayloadDefC/DMCUKFMsgPayload.h"
#include "architecture/messaging/msgHeader.h"

//! structure definition
typedef struct {
    MsgHeader header;              //!< message header, zero'd on construction
    DMCUKFMsgPayload payload;		        //!< message copy, zero'd on construction
    DMCUKFMsgPayload *payloadPointer;	    //!< pointer to message
...
void DMCUKFMsg_C_addAuthor(DMCUKFMsg_C *coowner, DMCUKFMsg_C *data);
