...
void CamNav3Msg_C_addAuthor(CamNav3Msg_C *coownerMsg, CamNav3Msg_C *targetMsg) {
...
void CamNav3Msg_C_init(CamNav3Msg_C *owner) {
    ...
    if (owner->payloadPointer == 0) {
        CamNav3Msg_C_addAuthor(owner, owner);
    }
};
...
CamNav3MsgPayload CamNav3Msg_C_zeroMsgPayload() {
    CamNav3MsgPayload zeroMsg;
    memset(&zeroMsg, 0x0, sizeof(CamNav3MsgPayload));
    return zeroMsg;
};
...
CamNav3MsgPayload CamNav3Msg_C_read(CamNav3Msg_C *source) {
    if (!source->headerPointer->isWritten) {
        BSK_PRINT(MSG_ERROR,"In C input msg, you are trying to read an un-written message of type CamNav3Msg.");
    }
...
int CamNav3Msg_C_isWritten(CamNav3Msg_C *data) {
    ...
    BSK_PRINT(MSG_ERROR,"In C input msg, you are checking if an unconnected msg of type CamNav3Msg is written.");
    return 0;
};
...
uint64_t CamNav3Msg_C_timeWritten(CamNav3Msg_C *data) {
    ...
    BSK_PRINT(MSG_ERROR,"In C input msg, you are requesting the write time of an unconnected msg of type CamNav3Msg.");
    return 0;
};
...
int64_t CamNav3Msg_C_moduleID(CamNav3Msg_C *data) {
    if (!data->header.isLinked) {
        BSK_PRINT(MSG_ERROR,"In C input msg, you are requesting moduleID of an unconnected msg of type CamNav3Msg.");
        return 0;
    }
    if (!data->headerPointer->isWritten) {
        BSK_PRINT(MSG_ERROR,"In C input msg, you are requesting moduleID of an unwritten msg of type CamNav3Msg.");
        return 0;
    }
...
void CamNav3Msg_cpp_subscribe(CamNav3Msg_C *subscriber, void* source){
    Message<CamNav3MsgPayload>* source_t = (Message<CamNav3MsgPayload>*) source;
    MsgHeader *msgPtr;
