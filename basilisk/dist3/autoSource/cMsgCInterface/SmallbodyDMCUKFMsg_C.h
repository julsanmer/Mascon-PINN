...
#ifndef SmallbodyDMCUKFMsg_C_H
#define SmallbodyDMCUKFMsg_C_H

#include <stdint.h>
#include "architecture/../../External/msgPayloadDefC/SmallbodyDMCUKFMsgPayload.h"
#include "architecture/messaging/msgHeader.h"

//! structure definition
typedef struct {
    MsgHeader header;              //!< message header, zero'd on construction
    SmallbodyDMCUKFMsgPayload payload;		        //!< message copy, zero'd on construction
    SmallbodyDMCUKFMsgPayload *payloadPointer;	    //!< pointer to message
    MsgHeader *headerPointer;      //!< pointer to message header
} SmallbodyDMCUKFMsg_C;
...
void SmallbodyDMCUKFMsg_C_addAuthor(SmallbodyDMCUKFMsg_C *coowner, SmallbodyDMCUKFMsg_C *data);
