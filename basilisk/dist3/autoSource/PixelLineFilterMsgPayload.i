...
%module PixelLineFilterMsgPayload
%{
    #include "msgPayloadDefC/PixelLineFilterMsgPayload.h"
...
%template(PixelLineFilterMsgOutMsgsVector) std::vector<Message<PixelLineFilterMsgPayload>>;
%template(PixelLineFilterMsgOutMsgsPtrVector) std::vector<Message<PixelLineFilterMsgPayload>*>;
%template(PixelLineFilterMsgInMsgsVector) std::vector<ReadFunctor<PixelLineFilterMsgPayload>>;
