...
%module SmallBodyNavMsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNavMsgPayload.h"
...
%template(SmallBodyNavMsgOutMsgsVector) std::vector<Message<SmallBodyNavMsgPayload>>;
%template(SmallBodyNavMsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavMsgPayload>*>;
%template(SmallBodyNavMsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavMsgPayload>>;
