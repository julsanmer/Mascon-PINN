...
%template(VSCMGConfigMsgOutMsgsVector) std::vector<Message<VSCMGConfigMsgPayload>>;
%template(VSCMGConfigMsgOutMsgsPtrVector) std::vector<Message<VSCMGConfigMsgPayload>*>;
%template(VSCMGConfigMsgInMsgsVector) std::vector<ReadFunctor<VSCMGConfigMsgPayload>>;
