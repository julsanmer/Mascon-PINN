...
%};
%include "msgPayloadDefC/DMCUKFMsgPayload.h"
INSTANTIATE_TEMPLATES(DMCUKFMsg, DMCUKFMsgPayload, msgPayloadDefC)
%template(DMCUKFMsgOutMsgsVector) std::vector<Message<DMCUKFMsgPayload>>;
%template(DMCUKFMsgOutMsgsPtrVector) std::vector<Message<DMCUKFMsgPayload>*>;
%template(DMCUKFMsgInMsgsVector) std::vector<ReadFunctor<DMCUKFMsgPayload>>;
