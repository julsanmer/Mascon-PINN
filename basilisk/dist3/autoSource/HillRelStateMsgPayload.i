...
%module HillRelStateMsgPayload
%{
    #include "msgPayloadDefC/HillRelStateMsgPayload.h"
...
%template(HillRelStateMsgOutMsgsVector) std::vector<Message<HillRelStateMsgPayload>>;
%template(HillRelStateMsgOutMsgsPtrVector) std::vector<Message<HillRelStateMsgPayload>*>;
%template(HillRelStateMsgInMsgsVector) std::vector<ReadFunctor<HillRelStateMsgPayload>>;
