...
%module TemperatureMsgPayload
%{
    #include "msgPayloadDefC/TemperatureMsgPayload.h"
...
%template(TemperatureMsgOutMsgsVector) std::vector<Message<TemperatureMsgPayload>>;
%template(TemperatureMsgOutMsgsPtrVector) std::vector<Message<TemperatureMsgPayload>*>;
%template(TemperatureMsgInMsgsVector) std::vector<ReadFunctor<TemperatureMsgPayload>>;
