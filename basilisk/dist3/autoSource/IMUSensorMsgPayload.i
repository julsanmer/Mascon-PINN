...
%template(IMUSensorMsgOutMsgsVector) std::vector<Message<IMUSensorMsgPayload>>;
%template(IMUSensorMsgOutMsgsPtrVector) std::vector<Message<IMUSensorMsgPayload>*>;
%template(IMUSensorMsgInMsgsVector) std::vector<ReadFunctor<IMUSensorMsgPayload>>;
