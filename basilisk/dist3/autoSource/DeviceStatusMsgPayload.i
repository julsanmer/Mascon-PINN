...
%template(DeviceStatusMsgOutMsgsVector) std::vector<Message<DeviceStatusMsgPayload>>;
%template(DeviceStatusMsgOutMsgsPtrVector) std::vector<Message<DeviceStatusMsgPayload>*>;
%template(DeviceStatusMsgInMsgsVector) std::vector<ReadFunctor<DeviceStatusMsgPayload>>;
