...
%module DataStorageStatusMsgPayload
%{
    #include "msgPayloadDefCpp/DataStorageStatusMsgPayload.h"
...
%template(DataStorageStatusMsgOutMsgsVector) std::vector<Message<DataStorageStatusMsgPayload>>;
%template(DataStorageStatusMsgOutMsgsPtrVector) std::vector<Message<DataStorageStatusMsgPayload>*>;
%template(DataStorageStatusMsgInMsgsVector) std::vector<ReadFunctor<DataStorageStatusMsgPayload>>;
