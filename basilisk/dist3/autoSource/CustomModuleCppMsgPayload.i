...
%module CustomModuleCppMsgPayload
%{
...
%};
%include "msgPayloadDefCpp/CustomModuleCppMsgPayload.h"
INSTANTIATE_TEMPLATES(CustomModuleCppMsg, CustomModuleCppMsgPayload, msgPayloadDefCpp)
%template(CustomModuleCppMsgOutMsgsVector) std::vector<Message<CustomModuleCppMsgPayload>>;
%template(CustomModuleCppMsgOutMsgsPtrVector) std::vector<Message<CustomModuleCppMsgPayload>*>;
%template(CustomModuleCppMsgInMsgsVector) std::vector<ReadFunctor<CustomModuleCppMsgPayload>>;
