...
%template(CameraImageMsgOutMsgsVector) std::vector<Message<CameraImageMsgPayload>>;
%template(CameraImageMsgOutMsgsPtrVector) std::vector<Message<CameraImageMsgPayload>*>;
%template(CameraImageMsgInMsgsVector) std::vector<ReadFunctor<CameraImageMsgPayload>>;
