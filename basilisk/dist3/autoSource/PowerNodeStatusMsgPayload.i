...
%module PowerNodeStatusMsgPayload
%{
    #include "msgPayloadDefC/PowerNodeStatusMsgPayload.h"
...
%template(PowerNodeStatusMsgOutMsgsVector) std::vector<Message<PowerNodeStatusMsgPayload>>;
%template(PowerNodeStatusMsgOutMsgsPtrVector) std::vector<Message<PowerNodeStatusMsgPayload>*>;
%template(PowerNodeStatusMsgInMsgsVector) std::vector<ReadFunctor<PowerNodeStatusMsgPayload>>;
