...
%template(EphemerisMsgOutMsgsVector) std::vector<Message<EphemerisMsgPayload>>;
%template(EphemerisMsgOutMsgsPtrVector) std::vector<Message<EphemerisMsgPayload>*>;
%template(EphemerisMsgInMsgsVector) std::vector<ReadFunctor<EphemerisMsgPayload>>;
