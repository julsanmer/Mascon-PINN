...
%module SmallBodyNavIntMsgPayload
%{
...
%};
%include "msgPayloadDefC/SmallBodyNavIntMsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNavIntMsg, SmallBodyNavIntMsgPayload, msgPayloadDefC)
%template(SmallBodyNavIntMsgOutMsgsVector) std::vector<Message<SmallBodyNavIntMsgPayload>>;
%template(SmallBodyNavIntMsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavIntMsgPayload>*>;
%template(SmallBodyNavIntMsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavIntMsgPayload>>;
