...
%module ReconfigBurnArrayInfoMsgPayload
%{
    #include "msgPayloadDefC/ReconfigBurnArrayInfoMsgPayload.h"
...
%template(ReconfigBurnArrayInfoMsgOutMsgsVector) std::vector<Message<ReconfigBurnArrayInfoMsgPayload>>;
%template(ReconfigBurnArrayInfoMsgOutMsgsPtrVector) std::vector<Message<ReconfigBurnArrayInfoMsgPayload>*>;
%template(ReconfigBurnArrayInfoMsgInMsgsVector) std::vector<ReadFunctor<ReconfigBurnArrayInfoMsgPayload>>;
