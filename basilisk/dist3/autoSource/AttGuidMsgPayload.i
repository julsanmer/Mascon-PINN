...
%template(AttGuidMsgOutMsgsVector) std::vector<Message<AttGuidMsgPayload>>;
%template(AttGuidMsgOutMsgsPtrVector) std::vector<Message<AttGuidMsgPayload>*>;
%template(AttGuidMsgInMsgsVector) std::vector<ReadFunctor<AttGuidMsgPayload>>;
