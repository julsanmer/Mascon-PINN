...
%module SmallBodyNav4MsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNav4MsgPayload.h"
...
%};
%include "msgPayloadDefC/SmallBodyNav4MsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNav4Msg, SmallBodyNav4MsgPayload, msgPayloadDefC)
%template(SmallBodyNav4MsgOutMsgsVector) std::vector<Message<SmallBodyNav4MsgPayload>>;
%template(SmallBodyNav4MsgOutMsgsPtrVector) std::vector<Message<SmallBodyNav4MsgPayload>*>;
%template(SmallBodyNav4MsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNav4MsgPayload>>;
