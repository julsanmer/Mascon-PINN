...
%module THRArrayCmdForceMsgPayload
%{
...
%template(THRArrayCmdForceMsgOutMsgsVector) std::vector<Message<THRArrayCmdForceMsgPayload>>;
%template(THRArrayCmdForceMsgOutMsgsPtrVector) std::vector<Message<THRArrayCmdForceMsgPayload>*>;
%template(THRArrayCmdForceMsgInMsgsVector) std::vector<ReadFunctor<THRArrayCmdForceMsgPayload>>;
