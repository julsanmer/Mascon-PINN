...
%template(NavAttMsgOutMsgsVector) std::vector<Message<NavAttMsgPayload>>;
%template(NavAttMsgOutMsgsPtrVector) std::vector<Message<NavAttMsgPayload>*>;
%template(NavAttMsgInMsgsVector) std::vector<ReadFunctor<NavAttMsgPayload>>;
