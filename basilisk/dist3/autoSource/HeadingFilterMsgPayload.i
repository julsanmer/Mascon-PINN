...
%module HeadingFilterMsgPayload
%{
...
%template(HeadingFilterMsgOutMsgsVector) std::vector<Message<HeadingFilterMsgPayload>>;
%template(HeadingFilterMsgOutMsgsPtrVector) std::vector<Message<HeadingFilterMsgPayload>*>;
%template(HeadingFilterMsgInMsgsVector) std::vector<ReadFunctor<HeadingFilterMsgPayload>>;
