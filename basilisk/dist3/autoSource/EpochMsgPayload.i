...
%template(EpochMsgOutMsgsVector) std::vector<Message<EpochMsgPayload>>;
%template(EpochMsgOutMsgsPtrVector) std::vector<Message<EpochMsgPayload>*>;
%template(EpochMsgInMsgsVector) std::vector<ReadFunctor<EpochMsgPayload>>;
