...
%module SmallBodyNavUKF4MsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNavUKF4MsgPayload.h"
...
%};
%include "msgPayloadDefC/SmallBodyNavUKF4MsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNavUKF4Msg, SmallBodyNavUKF4MsgPayload, msgPayloadDefC)
%template(SmallBodyNavUKF4MsgOutMsgsVector) std::vector<Message<SmallBodyNavUKF4MsgPayload>>;
%template(SmallBodyNavUKF4MsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavUKF4MsgPayload>*>;
%template(SmallBodyNavUKF4MsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavUKF4MsgPayload>>;
