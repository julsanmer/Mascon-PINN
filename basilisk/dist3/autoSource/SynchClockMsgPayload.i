...
%template(SynchClockMsgOutMsgsVector) std::vector<Message<SynchClockMsgPayload>>;
%template(SynchClockMsgOutMsgsPtrVector) std::vector<Message<SynchClockMsgPayload>*>;
%template(SynchClockMsgInMsgsVector) std::vector<ReadFunctor<SynchClockMsgPayload>>;
