...
%module MagneticFieldMsgPayload
%{
...
%template(MagneticFieldMsgOutMsgsVector) std::vector<Message<MagneticFieldMsgPayload>>;
%template(MagneticFieldMsgOutMsgsPtrVector) std::vector<Message<MagneticFieldMsgPayload>*>;
%template(MagneticFieldMsgInMsgsVector) std::vector<ReadFunctor<MagneticFieldMsgPayload>>;
