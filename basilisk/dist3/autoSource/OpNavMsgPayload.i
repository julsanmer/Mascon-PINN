...
%template(OpNavMsgOutMsgsVector) std::vector<Message<OpNavMsgPayload>>;
%template(OpNavMsgOutMsgsPtrVector) std::vector<Message<OpNavMsgPayload>*>;
%template(OpNavMsgInMsgsVector) std::vector<ReadFunctor<OpNavMsgPayload>>;
