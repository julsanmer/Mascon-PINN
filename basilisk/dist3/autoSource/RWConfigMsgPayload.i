...
%template(RWConfigMsgOutMsgsVector) std::vector<Message<RWConfigMsgPayload>>;
%template(RWConfigMsgOutMsgsPtrVector) std::vector<Message<RWConfigMsgPayload>*>;
%template(RWConfigMsgInMsgsVector) std::vector<ReadFunctor<RWConfigMsgPayload>>;
