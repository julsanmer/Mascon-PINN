...
%module PrescribedTransMsgPayload
%{
    #include "msgPayloadDefC/PrescribedTransMsgPayload.h"
...
%template(PrescribedTransMsgOutMsgsVector) std::vector<Message<PrescribedTransMsgPayload>>;
%template(PrescribedTransMsgOutMsgsPtrVector) std::vector<Message<PrescribedTransMsgPayload>*>;
%template(PrescribedTransMsgInMsgsVector) std::vector<ReadFunctor<PrescribedTransMsgPayload>>;
