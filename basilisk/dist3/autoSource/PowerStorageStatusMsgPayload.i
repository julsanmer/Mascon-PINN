...
%module PowerStorageStatusMsgPayload
%{
...
%template(PowerStorageStatusMsgOutMsgsVector) std::vector<Message<PowerStorageStatusMsgPayload>>;
%template(PowerStorageStatusMsgOutMsgsPtrVector) std::vector<Message<PowerStorageStatusMsgPayload>*>;
%template(PowerStorageStatusMsgInMsgsVector) std::vector<ReadFunctor<PowerStorageStatusMsgPayload>>;
