...
%template(AttRefMsgOutMsgsVector) std::vector<Message<AttRefMsgPayload>>;
%template(AttRefMsgOutMsgsPtrVector) std::vector<Message<AttRefMsgPayload>*>;
%template(AttRefMsgInMsgsVector) std::vector<ReadFunctor<AttRefMsgPayload>>;
