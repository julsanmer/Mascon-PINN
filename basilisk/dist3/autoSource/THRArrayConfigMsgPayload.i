...
%module THRArrayConfigMsgPayload
%{
...
%template(THRArrayConfigMsgOutMsgsVector) std::vector<Message<THRArrayConfigMsgPayload>>;
%template(THRArrayConfigMsgOutMsgsPtrVector) std::vector<Message<THRArrayConfigMsgPayload>*>;
%template(THRArrayConfigMsgInMsgsVector) std::vector<ReadFunctor<THRArrayConfigMsgPayload>>;
