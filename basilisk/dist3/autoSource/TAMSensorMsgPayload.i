...
%template(TAMSensorMsgOutMsgsVector) std::vector<Message<TAMSensorMsgPayload>>;
%template(TAMSensorMsgOutMsgsPtrVector) std::vector<Message<TAMSensorMsgPayload>*>;
%template(TAMSensorMsgInMsgsVector) std::vector<ReadFunctor<TAMSensorMsgPayload>>;
