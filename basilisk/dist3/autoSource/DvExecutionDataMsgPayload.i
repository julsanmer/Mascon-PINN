...
%module DvExecutionDataMsgPayload
%{
    #include "msgPayloadDefC/DvExecutionDataMsgPayload.h"
...
%template(DvExecutionDataMsgOutMsgsVector) std::vector<Message<DvExecutionDataMsgPayload>>;
%template(DvExecutionDataMsgOutMsgsPtrVector) std::vector<Message<DvExecutionDataMsgPayload>*>;
%template(DvExecutionDataMsgInMsgsVector) std::vector<ReadFunctor<DvExecutionDataMsgPayload>>;
