...
%module VehicleConfigMsgPayload
%{
...
%template(VehicleConfigMsgOutMsgsVector) std::vector<Message<VehicleConfigMsgPayload>>;
%template(VehicleConfigMsgOutMsgsPtrVector) std::vector<Message<VehicleConfigMsgPayload>*>;
%template(VehicleConfigMsgInMsgsVector) std::vector<ReadFunctor<VehicleConfigMsgPayload>>;
