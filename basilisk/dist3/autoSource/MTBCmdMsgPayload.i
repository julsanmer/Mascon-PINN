...
%module MTBCmdMsgPayload
%{
    #include "msgPayloadDefC/MTBCmdMsgPayload.h"
...
%template(MTBCmdMsgOutMsgsVector) std::vector<Message<MTBCmdMsgPayload>>;
%template(MTBCmdMsgOutMsgsPtrVector) std::vector<Message<MTBCmdMsgPayload>*>;
%template(MTBCmdMsgInMsgsVector) std::vector<ReadFunctor<MTBCmdMsgPayload>>;
