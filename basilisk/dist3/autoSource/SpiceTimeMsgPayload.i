...
%template(SpiceTimeMsgOutMsgsVector) std::vector<Message<SpiceTimeMsgPayload>>;
%template(SpiceTimeMsgOutMsgsPtrVector) std::vector<Message<SpiceTimeMsgPayload>*>;
%template(SpiceTimeMsgInMsgsVector) std::vector<ReadFunctor<SpiceTimeMsgPayload>>;
