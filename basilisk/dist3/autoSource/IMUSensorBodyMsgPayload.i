...
%module IMUSensorBodyMsgPayload
%{
    #include "msgPayloadDefC/IMUSensorBodyMsgPayload.h"
...
%template(IMUSensorBodyMsgOutMsgsVector) std::vector<Message<IMUSensorBodyMsgPayload>>;
%template(IMUSensorBodyMsgOutMsgsPtrVector) std::vector<Message<IMUSensorBodyMsgPayload>*>;
%template(IMUSensorBodyMsgInMsgsVector) std::vector<ReadFunctor<IMUSensorBodyMsgPayload>>;
