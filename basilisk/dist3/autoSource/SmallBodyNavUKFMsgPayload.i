...
%module SmallBodyNavUKFMsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNavUKFMsgPayload.h"
...
%template(SmallBodyNavUKFMsgOutMsgsVector) std::vector<Message<SmallBodyNavUKFMsgPayload>>;
%template(SmallBodyNavUKFMsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavUKFMsgPayload>*>;
%template(SmallBodyNavUKFMsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavUKFMsgPayload>>;
