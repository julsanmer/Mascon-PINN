...
%module SmallBodyNav2MsgPayload
%{
...
%};
%include "msgPayloadDefC/SmallBodyNav2MsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNav2Msg, SmallBodyNav2MsgPayload, msgPayloadDefC)
%template(SmallBodyNav2MsgOutMsgsVector) std::vector<Message<SmallBodyNav2MsgPayload>>;
%template(SmallBodyNav2MsgOutMsgsPtrVector) std::vector<Message<SmallBodyNav2MsgPayload>*>;
%template(SmallBodyNav2MsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNav2MsgPayload>>;
