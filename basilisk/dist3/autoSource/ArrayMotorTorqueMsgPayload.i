...
%module ArrayMotorTorqueMsgPayload
%{
...
%template(ArrayMotorTorqueMsgOutMsgsVector) std::vector<Message<ArrayMotorTorqueMsgPayload>>;
%template(ArrayMotorTorqueMsgOutMsgsPtrVector) std::vector<Message<ArrayMotorTorqueMsgPayload>*>;
%template(ArrayMotorTorqueMsgInMsgsVector) std::vector<ReadFunctor<ArrayMotorTorqueMsgPayload>>;
