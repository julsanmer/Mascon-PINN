...
%module MTBArrayConfigMsgPayload
%{
    #include "msgPayloadDefC/MTBArrayConfigMsgPayload.h"
...
%template(MTBArrayConfigMsgOutMsgsVector) std::vector<Message<MTBArrayConfigMsgPayload>>;
%template(MTBArrayConfigMsgOutMsgsPtrVector) std::vector<Message<MTBArrayConfigMsgPayload>*>;
%template(MTBArrayConfigMsgInMsgsVector) std::vector<ReadFunctor<MTBArrayConfigMsgPayload>>;
