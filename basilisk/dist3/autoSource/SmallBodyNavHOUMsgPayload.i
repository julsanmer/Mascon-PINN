...
%module SmallBodyNavHOUMsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNavHOUMsgPayload.h"
...
%};
%include "msgPayloadDefC/SmallBodyNavHOUMsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNavHOUMsg, SmallBodyNavHOUMsgPayload, msgPayloadDefC)
%template(SmallBodyNavHOUMsgOutMsgsVector) std::vector<Message<SmallBodyNavHOUMsgPayload>>;
%template(SmallBodyNavHOUMsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavHOUMsgPayload>*>;
%template(SmallBodyNavHOUMsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavHOUMsgPayload>>;
