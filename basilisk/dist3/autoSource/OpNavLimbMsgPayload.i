...
%module OpNavLimbMsgPayload
%{
    #include "msgPayloadDefC/OpNavLimbMsgPayload.h"
...
%template(OpNavLimbMsgOutMsgsVector) std::vector<Message<OpNavLimbMsgPayload>>;
%template(OpNavLimbMsgOutMsgsPtrVector) std::vector<Message<OpNavLimbMsgPayload>*>;
%template(OpNavLimbMsgInMsgsVector) std::vector<ReadFunctor<OpNavLimbMsgPayload>>;
