...
%template(CmdForceBodyMsgOutMsgsVector) std::vector<Message<CmdForceBodyMsgPayload>>;
%template(CmdForceBodyMsgOutMsgsPtrVector) std::vector<Message<CmdForceBodyMsgPayload>*>;
%template(CmdForceBodyMsgInMsgsVector) std::vector<ReadFunctor<CmdForceBodyMsgPayload>>;
