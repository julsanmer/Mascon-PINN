...
%module CSSUnitConfigMsgPayload
%{
...
%template(CSSUnitConfigMsgOutMsgsVector) std::vector<Message<CSSUnitConfigMsgPayload>>;
%template(CSSUnitConfigMsgOutMsgsPtrVector) std::vector<Message<CSSUnitConfigMsgPayload>*>;
%template(CSSUnitConfigMsgInMsgsVector) std::vector<ReadFunctor<CSSUnitConfigMsgPayload>>;
