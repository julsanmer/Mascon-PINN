...
%module SmallBodyNavUKF2MsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNavUKF2MsgPayload.h"
...
%};
%include "msgPayloadDefC/SmallBodyNavUKF2MsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNavUKF2Msg, SmallBodyNavUKF2MsgPayload, msgPayloadDefC)
%template(SmallBodyNavUKF2MsgOutMsgsVector) std::vector<Message<SmallBodyNavUKF2MsgPayload>>;
%template(SmallBodyNavUKF2MsgOutMsgsPtrVector) std::vector<Message<SmallBodyNavUKF2MsgPayload>*>;
%template(SmallBodyNavUKF2MsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNavUKF2MsgPayload>>;
