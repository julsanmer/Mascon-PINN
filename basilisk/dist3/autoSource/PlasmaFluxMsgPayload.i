...
%module PlasmaFluxMsgPayload
%{
    #include "msgPayloadDefC/PlasmaFluxMsgPayload.h"
...
%template(PlasmaFluxMsgOutMsgsVector) std::vector<Message<PlasmaFluxMsgPayload>>;
%template(PlasmaFluxMsgOutMsgsPtrVector) std::vector<Message<PlasmaFluxMsgPayload>*>;
%template(PlasmaFluxMsgInMsgsVector) std::vector<ReadFunctor<PlasmaFluxMsgPayload>>;
