...
%module SCEnergyMomentumMsgPayload
%{
...
%template(SCEnergyMomentumMsgOutMsgsVector) std::vector<Message<SCEnergyMomentumMsgPayload>>;
%template(SCEnergyMomentumMsgOutMsgsPtrVector) std::vector<Message<SCEnergyMomentumMsgPayload>*>;
%template(SCEnergyMomentumMsgInMsgsVector) std::vector<ReadFunctor<SCEnergyMomentumMsgPayload>>;
