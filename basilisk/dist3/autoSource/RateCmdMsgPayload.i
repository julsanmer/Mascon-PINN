...
%template(RateCmdMsgOutMsgsVector) std::vector<Message<RateCmdMsgPayload>>;
%template(RateCmdMsgOutMsgsPtrVector) std::vector<Message<RateCmdMsgPayload>*>;
%template(RateCmdMsgInMsgsVector) std::vector<ReadFunctor<RateCmdMsgPayload>>;
