...
%module DeviceCmdMsgPayload
%{
    #include "msgPayloadDefC/DeviceCmdMsgPayload.h"
...
%template(DeviceCmdMsgOutMsgsVector) std::vector<Message<DeviceCmdMsgPayload>>;
%template(DeviceCmdMsgOutMsgsPtrVector) std::vector<Message<DeviceCmdMsgPayload>*>;
%template(DeviceCmdMsgInMsgsVector) std::vector<ReadFunctor<DeviceCmdMsgPayload>>;
