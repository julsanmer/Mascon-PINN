...
%template(DvBurnCmdMsgOutMsgsVector) std::vector<Message<DvBurnCmdMsgPayload>>;
%template(DvBurnCmdMsgOutMsgsPtrVector) std::vector<Message<DvBurnCmdMsgPayload>*>;
%template(DvBurnCmdMsgInMsgsVector) std::vector<ReadFunctor<DvBurnCmdMsgPayload>>;
