...
%template(EclipseMsgOutMsgsVector) std::vector<Message<EclipseMsgPayload>>;
%template(EclipseMsgOutMsgsPtrVector) std::vector<Message<EclipseMsgPayload>*>;
%template(EclipseMsgInMsgsVector) std::vector<ReadFunctor<EclipseMsgPayload>>;
