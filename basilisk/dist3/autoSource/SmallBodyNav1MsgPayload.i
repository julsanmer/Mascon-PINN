...
%module SmallBodyNav1MsgPayload
%{
    #include "msgPayloadDefC/SmallBodyNav1MsgPayload.h"
...
%};
%include "msgPayloadDefC/SmallBodyNav1MsgPayload.h"
INSTANTIATE_TEMPLATES(SmallBodyNav1Msg, SmallBodyNav1MsgPayload, msgPayloadDefC)
%template(SmallBodyNav1MsgOutMsgsVector) std::vector<Message<SmallBodyNav1MsgPayload>>;
%template(SmallBodyNav1MsgOutMsgsPtrVector) std::vector<Message<SmallBodyNav1MsgPayload>*>;
%template(SmallBodyNav1MsgInMsgsVector) std::vector<ReadFunctor<SmallBodyNav1MsgPayload>>;
