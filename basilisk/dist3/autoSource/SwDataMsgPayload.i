...
%template(SwDataMsgOutMsgsVector) std::vector<Message<SwDataMsgPayload>>;
%template(SwDataMsgOutMsgsPtrVector) std::vector<Message<SwDataMsgPayload>*>;
%template(SwDataMsgInMsgsVector) std::vector<ReadFunctor<SwDataMsgPayload>>;
