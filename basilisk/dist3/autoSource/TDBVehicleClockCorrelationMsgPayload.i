...
%module TDBVehicleClockCorrelationMsgPayload
%{
    #include "msgPayloadDefC/TDBVehicleClockCorrelationMsgPayload.h"
...
%template(TDBVehicleClockCorrelationMsgOutMsgsVector) std::vector<Message<TDBVehicleClockCorrelationMsgPayload>>;
%template(TDBVehicleClockCorrelationMsgOutMsgsPtrVector) std::vector<Message<TDBVehicleClockCorrelationMsgPayload>*>;
%template(TDBVehicleClockCorrelationMsgInMsgsVector) std::vector<ReadFunctor<TDBVehicleClockCorrelationMsgPayload>>;
