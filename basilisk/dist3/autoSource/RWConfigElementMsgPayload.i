...
%module RWConfigElementMsgPayload
%{
    #include "msgPayloadDefC/RWConfigElementMsgPayload.h"
...
%template(RWConfigElementMsgOutMsgsVector) std::vector<Message<RWConfigElementMsgPayload>>;
%template(RWConfigElementMsgOutMsgsPtrVector) std::vector<Message<RWConfigElementMsgPayload>*>;
%template(RWConfigElementMsgInMsgsVector) std::vector<ReadFunctor<RWConfigElementMsgPayload>>;
