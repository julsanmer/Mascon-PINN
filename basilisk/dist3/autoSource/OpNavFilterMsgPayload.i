...
%module OpNavFilterMsgPayload
%{
    #include "msgPayloadDefC/OpNavFilterMsgPayload.h"
...
%template(OpNavFilterMsgOutMsgsVector) std::vector<Message<OpNavFilterMsgPayload>>;
%template(OpNavFilterMsgOutMsgsPtrVector) std::vector<Message<OpNavFilterMsgPayload>*>;
%template(OpNavFilterMsgInMsgsVector) std::vector<ReadFunctor<OpNavFilterMsgPayload>>;
