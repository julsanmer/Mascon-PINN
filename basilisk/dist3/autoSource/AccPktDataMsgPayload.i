...
%template(AccPktDataMsgOutMsgsVector) std::vector<Message<AccPktDataMsgPayload>>;
%template(AccPktDataMsgOutMsgsPtrVector) std::vector<Message<AccPktDataMsgPayload>*>;
%template(AccPktDataMsgInMsgsVector) std::vector<ReadFunctor<AccPktDataMsgPayload>>;
