...
%template(STSensorMsgOutMsgsVector) std::vector<Message<STSensorMsgPayload>>;
%template(STSensorMsgOutMsgsPtrVector) std::vector<Message<STSensorMsgPayload>*>;
%template(STSensorMsgInMsgsVector) std::vector<ReadFunctor<STSensorMsgPayload>>;
