...
%template(VSCMGSpeedMsgOutMsgsVector) std::vector<Message<VSCMGSpeedMsgPayload>>;
%template(VSCMGSpeedMsgOutMsgsPtrVector) std::vector<Message<VSCMGSpeedMsgPayload>*>;
%template(VSCMGSpeedMsgInMsgsVector) std::vector<ReadFunctor<VSCMGSpeedMsgPayload>>;
