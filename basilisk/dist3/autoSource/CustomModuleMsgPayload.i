...
%};
%include "msgPayloadDefC/CustomModuleMsgPayload.h"
INSTANTIATE_TEMPLATES(CustomModuleMsg, CustomModuleMsgPayload, msgPayloadDefC)
%template(CustomModuleMsgOutMsgsVector) std::vector<Message<CustomModuleMsgPayload>>;
%template(CustomModuleMsgOutMsgsPtrVector) std::vector<Message<CustomModuleMsgPayload>*>;
%template(CustomModuleMsgInMsgsVector) std::vector<ReadFunctor<CustomModuleMsgPayload>>;
