...
from src.shape.polyhedron import PolyhedronShape
from src.gravity.mascon.masconModel import MasconGrav
from src.gravity.polyhedron.polyhedronModel import PolyhedronGrav
from src.gravity.pinn.pinnModel import PINNGrav
from src.gravity.spherharm.spherharmModel import SpherharmGrav
...
class Asteroid:
    ...
    def add_mascon(self, mu_M=None, xyz_M=None, training=False):
    ...
    def add_pinn(self, file_torch=None, training=False):
